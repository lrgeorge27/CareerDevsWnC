...
var view = {
    displayTodos: function() { //creates a dynamic list display.
        ...
        //     var todo = todoList.todos[i]; //create a variable to access each todos item for copletion if/else statement. Saves us from typing todoList.todos[i] repeatedly.
        ...
        todoList.todos.forEach(function(todo, position) {
            ...
            todoLi.id = position; //create an id and set it equal to the index number
            todoLi.textContent = todoTextWithCompletion; //replaces line below and includes completion info.
            todoLi.appendChild(this.createDeleteButton());
            todosUl.appendChild(todoLi); //places the list element with text into the unordered list.
        }, this);
